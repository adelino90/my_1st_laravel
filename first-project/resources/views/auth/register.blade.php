    ...
    <div class="flex justify-center">
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <form action="{{ route('register')}}" method="post">
                @csrf
                    <div class="mb-4">
                      <label for="name" class="sr-only" for="inline-full-name">Name</label>
                    ...
                    <div class="mb-4">
                        <label for="username" class="sr-only" for="inline-full-name">Username</label>
                    ...
                    <div class="mb-4">
                        <label for="email" class="sr-only" for="inline-full-name">Email</label>
                    ...
                    <div class="mb-4">
                        <label for="password" class="sr-only" for="inline-full-name">Password</label>
                    ...
                    <div class="mb-4">
                        <label for="password_confirmation" class="sr-only" for="inline-full-name">Password</label>
